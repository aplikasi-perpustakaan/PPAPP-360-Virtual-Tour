export default [
  {
    ...
    name: 'Floor 1 - i-Play Toys Room 1',
    caption: 'PUSAT - Floor 1 - i-Play Toys Room 1',
  ...
  },
  {
    ...
    name: 'Floor 1 - i-Play Toys Room 2',
    caption: 'PUSAT - Floor 1 - i-Play Toys Room 2',
  ...
  },
  {
    ...
    name: 'Floor 1 - i-Play Toys Room 3',
    caption: 'PUSAT - Floor 1 - i-Play Toys Room 3',
  ...
  },
  {
    ...
    name: 'Floor 1 - i-Play Toys Room 4',
    caption: 'PUSAT - Floor 1 - i-Play Toys Room 4',
  ...
  },
  {
    ...
    name: 'Floor 1 - i-Play Toys Room 5',
    caption: 'PUSAT - Floor 1 - i-Play Toys Room 5',
