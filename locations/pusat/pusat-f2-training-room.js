export default [
  {
    ...
    name: 'Level 2 - Training Room 1',
    caption: 'PUSAT - Level 2 - Training Room 1',
    ...
    links: [
      {
        ...
        name: 'Go to Level 2 - Training Room 2',
        targetYaw: '252.07deg',
        targetPitch: '1.42deg'
      },
  ...
  },
  {
    ...
    name: 'Level 2 - Training Room 2',
    caption: 'PUSAT - Level 2 - Training Room 2',
    ...
    links: [
      {
        ...
        name: 'Go to Level 2 - Training Room 3',
        targetYaw: '138.87deg',
        targetPitch: '4.55deg'
      },
  ...
  },
  {
    ...
    name: 'Level 2 - Training Room 3',
    caption: 'PUSAT - Level 2 - Training Room 3',
