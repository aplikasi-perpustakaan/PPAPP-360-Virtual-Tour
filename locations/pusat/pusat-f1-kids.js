export default [
  {
    ...
    caption: 'PUSAT - Floor 1 - Kids Area 1',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-1.jpg',
    ...
    links: [
      { nodeId: 'pusat-f1-kids-2', position: { yaw: '0deg', pitch: '0deg' }, name: 'Go to Kids 2' },
      {
        ...
        position: { yaw: '152.51deg', pitch: '-2.00deg' },
  ...
  },
  {
    ...
    caption: 'PUSAT - Floor 1 - Kids Area 2',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-2.jpg',
    ...
    links: [
      {
        ...
        position: { yaw: '156.32deg', pitch: '-2.14deg' },
      ...
      
      {
        ...
        position: { yaw: '41.28deg', pitch: '-2.61deg' },
      ...
      
      {
        ...
        position: { yaw: '10.59deg', pitch: '-4.96deg' },
        name: 'Go to Floor 1 - Kids Area 14',
        targetYaw: '50.55deg',
        targetPitch: '-0.06deg'
      },
      {
        ...
        name: 'Go to Floor 1 - Kids Area 13',
        targetYaw: '144.71deg',
        targetPitch: '7.32deg'
      },
    ],
  ...
  },
  {
    ...
    caption: 'PUSAT - Floor 1 - Kids Area 3',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-3.jpg',
    ...
    links: [
      {
        ...
        name: 'Go to Floor 1 - Kids Area 4'
      },
      ...
      
      {
        ...
        name: 'Go to Floor 1 - i-Play Toys Room 1'
      },
      {
        nodeId: 'pusat-f1-kids-13',
      ...
      },
      {
        ...
        position: { yaw: '108.97deg', pitch: '-5.37deg' },
      ...
      {
        nodeId: 'pusat-f1-kids-14',
        position: { yaw: '51.19deg', pitch: '-10deg' },
        name: 'Go to Floor 1 - Kids Area 14'
      },
    ],
    markers: [
      ...
      {
        id: 'pusat-f1-kids-3-marker-1789637828002',
        position: {
          yaw: '63.44deg',
          pitch: '-0.74deg'
        },
        ...
        data: {
          ...
          color: 'blue',
          animated: false,
          imageSrc: './images/pusat/markers/FLOOR-1/PUSAT_F1_68.jpg',
          originalUrl: './images/pusat/markers/FLOOR-1/PUSAT_F1_68.jpg',
          caption: ''
        },
        html: '<custom-marker type=\'image\' data-icon=\'info\' data-color=\'blue\' data-url=\'./images/pusat/markers/FLOOR-1/PUSAT_F1_68.jpg\'>\n        <img src=\'./images/pusat/markers/FLOOR-1/PUSAT_F1_68.jpg\' alt=\'\' style=\'cursor:pointer;\' />\n        <h2></h2>\n        <p style=\'font-size: 11px; opacity:0.7;\'>🔍 Click to enlarge</p>\n      </custom-marker>'
      }
    ],
    data: {
      floor: 'f1',
  ...
  },
  {
    ...
    caption: 'PUSAT - Floor 1 - Kids Area 4',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-4.jpg',
  ...
  },
  {
    ...
    caption: 'PUSAT - Floor 1 - Kids Area 5',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-5.jpg',
    ...
    links: [
      {
        ...
        name: 'Go to Floor 1 - Kids Area 6'
      },
      
      
      {
        nodeId: 'pusat-f1-kids-10',
        position: { yaw: '85.52deg', pitch: '-5.71deg' },
        name: 'Go to Floor 1 - Kids Area 10',
        targetYaw: '327.04deg',
        targetPitch: '0.92deg'
      },
    ],
  ...
  },
  {
    ...
    caption: 'PUSAT - Floor 1 - Kids Area 6',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-6.jpg',
    ...
    links: [
      {
        ...
        position: { yaw: '54.60deg', pitch: '0.85deg' },
        name: 'Go to Floor 1 - Kids Area 5',
        targetYaw: '52.94deg',
        targetPitch: '3.61deg'
      },
      ...
      
      {
        ...
        position: { yaw: '236.02deg', pitch: '-4.84deg' },
      ...
      
      {
        ...
        name: 'Go to Floor 1 - Sensory Room 1'
      },
    ],
    markers: [
      {
  ...
  {
    id: 'pusat-f1-kids-7',
    name: 'Floor 1 - Kids Area 7',
    caption: 'PUSAT - Floor 1 - Kids Area 7',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-7.jpg',
    ...
    links: [
      {
        nodeId: 'pusat-f1-kids-6',
        position: { yaw: '49.63deg', pitch: '-0.69deg' },
        name: 'Go to Floor 1 - Kids Area 6',
        targetYaw: '57.49deg',
        targetPitch: '-0.95deg'
      },
      ...
      
      {
        ...
        position: { yaw: '321.95deg', pitch: '-0.81deg' },
        name: 'Go to Floor 1 - Kids Area 8',
        targetYaw: '327.74deg',
        targetPitch: '-0.21deg'
      },
      ...
      
      {
        ...
        position: { yaw: '239.43deg', pitch: '-4.15deg' },
        name: 'Go to Floor 1 - Kids Area 9',
        targetYaw: '159.98deg',
        targetPitch: '-0.46deg'
      },
    ],
  ...
  {
    id: 'pusat-f1-kids-8',
    name: 'Floor 1 - Kids Area 8',
    caption: 'PUSAT - Floor 1 - Kids Area 8',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-8.jpg',
  ...
  {
    id: 'pusat-f1-kids-9',
    name: 'Floor 1 - Kids Area 9',
    caption: 'PUSAT - Floor 1 - Kids Area 9',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-9.jpg',
    ...
    links: [
      {
        nodeId: 'pusat-f1-kids-7',
        position: { yaw: '339.28deg', pitch: '-4.66deg' },
        name: 'Go to Floor 1 - Kids Area 7',
        targetYaw: '46.13deg',
        targetPitch: '1.92deg'
      },
  ...
  {
    id: 'pusat-f1-kids-10',
    name: 'Floor 1 - Kids Area 10',
    caption: 'PUSAT - Floor 1 - Kids Area 10',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-10.jpg',
    ...
    links: [
      {
        nodeId: 'pusat-f1-kids-5',
        position: { yaw: '191.49deg', pitch: '-4.26deg' },
        name: 'Go to Floor 1 - Kids Area 5',
        targetYaw: '239.98deg',
        targetPitch: '3.90deg'
      },
      ...
      
      {
        ...
        position: { yaw: '328.17deg', pitch: '-7.27deg' },
        name: 'Go to Floor 1 - Kids Area 15',
        targetYaw: '238.53deg',
        targetPitch: '-3.85deg'
      },
    ],
  ...
  {
    id: 'pusat-f1-kids-11',
    name: 'Floor 1 - Kids Area 11',
    caption: 'PUSAT - Floor 1 - Kids Area 11',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-11.jpg',
    ...
    links: [
      {
        ...
        name: 'Go to Floor 1 - Kids Area 12'
      },
    ],
    markers: [
      {
  ...
  {
    id: 'pusat-f1-kids-12',
    name: 'Floor 1 - Kids Area 12',
    caption: 'PUSAT - Floor 1 - Kids Area 12',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-12.jpg',
    ...
    links: [
      {
        ...
        name: 'Go to Floor 1 - Kids Area 11'
      },
  ...
  {
    id: 'pusat-f1-kids-13',
    name: 'Floor 1 - Kids Area 13',
    caption: 'PUSAT - Floor 1 - Kids Area 13',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-13.jpg',
    ...
    links: [
      ...
      {
        nodeId: 'pusat-f1-kids-14',
        position: { yaw: '250.40deg', pitch: '-3.76deg' },
        name: 'Go to Floor 1 - Kids Area 14',
        targetYaw: '135.61deg',
        targetPitch: '4.20deg'
      },
  ...
  {
    id: 'pusat-f1-kids-14',
    name: 'Floor 1 - Kids Area 14',
    caption: 'PUSAT - Floor 1 - Kids Area 14',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-14.jpg',
    ...
    links: [
      {
        nodeId: 'pusat-f1-kids-13',
        position: { yaw: '337.53deg', pitch: '-7.69deg' },
        name: 'Go to Floor 1 - Kids Area 13',
        targetYaw: '60.90deg',
        targetPitch: '1.74deg'
      },
      ...
      {
        nodeId: 'pusat-f1-kids-15',
        position: { yaw: '49.85deg', pitch: '-3.09deg' },
        name: 'Go to Floor 1 - Kids Area 15',
        targetYaw: '61.38deg',
        targetPitch: '1.59deg'
      },
      {
        nodeId: 'pusat-f1-kids-3',
        position: { yaw: '231.19deg', pitch: '-8.55deg' },
        name: 'Go to Floor 1 - Kids Area 3',
        targetYaw: '53.22deg',
        targetPitch: '0.92deg'
      },
      {
        nodeId: 'pusat-f1-kids-2',
        position: { yaw: '270.76deg', pitch: '-7.73deg' },
        name: 'Go to Floor 1 - Kids Area 2',
        targetYaw: '160.54deg',
        targetPitch: '-2.21deg'
      },
  ...
  {
    id: 'pusat-f1-kids-15',
    name: 'Floor 1 - Kids Area 15',
    caption: 'PUSAT - Floor 1 - Kids Area 15',
    panorama: './images/pusat/f1-kids/pusat-f1-kids-15.jpg',
    ...
    links: [
      {
        nodeId: 'pusat-f1-kids-14',
        position: { yaw: '232.80deg', pitch: '-7.62deg' },
        name: 'Go to Floor 1 - Kids Area 14',
        targetYaw: '230.23deg',
        targetPitch: '-3.28deg'
      },
      ...
      {
        nodeId: 'pusat-f1-kids-10',
        position: { yaw: '58.88deg', pitch: '-4.59deg' },
        name: 'Go to Floor 1 - Kids Area 10',
        targetYaw: '156.00deg',
        targetPitch: '-0.46deg'
      },
      ...
      
      {
        ...
        position: { yaw: '150.76deg', pitch: '-4.00deg' },
        name: 'Go to Floor 1 - Castle Area 3',
        targetYaw: '316.35deg',
        targetPitch: '-2.74deg'
      },
      {
        nodeId: 'pusat-f1-kids-13',
        position: { yaw: '293.77deg', pitch: '-3.73deg' },
        name: 'Go to Floor 1 - Kids Area 13',
        targetYaw: '53.10deg',
        targetPitch: '4.48deg'
      },
